...
def test_resolve_falls_back_to_mongo_when_raw_dir_yields_nothing(tmp_path: Path) -> None:
    """A configured-but-empty raw_dir (e.g. the default mount with no on-disk
    courses_YYYY_20X.json files) must not starve out real seeded data."""
