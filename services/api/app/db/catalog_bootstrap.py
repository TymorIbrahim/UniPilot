...
from app.db.demo_seed import seed_demo_catalog
...
async def ensure_development_catalog(database: AsyncIOMotorDatabase, settings: Settings | None = None) -> bool:
    ...
    if programs_existing == 0:
        if resolved.seed_demo_catalog:
            # The gallery demo shows the real Technion catalog instead of the
            # CI fixture -- see app/db/demo_seed.py.
            await seed_demo_catalog(database, resolved)
            return True
...
async def _seed_catalog_faculties_and_path_options(
    ...
    faculty_docs = [
        ...
        {
            "productionKey": "technion:faculty:faculty-aerospace-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-aerospace-engineering",
            "wikiSlug": "faculty-aerospace-engineering",
            "name": "הפקולטה להנדסת אוירונוטיקה וחלל",
            "nameHe": "הפקולטה להנדסת אוירונאוטיקה וחלל",
            "nameEn": "Faculty of Aerospace Engineering",
            "aliases": [
        ...
        {
            "productionKey": "technion:faculty:faculty-architecture-town-planning:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-architecture-town-planning",
            "wikiSlug": "faculty-architecture-town-planning",
            "name": "הפקולטה לארכיטקטורה ובינוי ערים",
            "nameHe": "הפקולטה לארכיטקטורה ובינוי ערים",
            "nameEn": "Faculty of Architecture and Town Planning",
            "aliases": ["Architecture", "Town Planning"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        },
        {
            "productionKey": "technion:faculty:faculty-biology:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-biology",
            "wikiSlug": "faculty-biology",
            "name": "הפקולטה לביולוגיה",
            "nameHe": "הפקולטה לביולוגיה",
        ...
        {
            "productionKey": "technion:faculty:faculty-biomedical-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-biomedical-engineering",
            "wikiSlug": "faculty-biomedical-engineering",
            "name": "הפקולטה להנדסה ביו-רפואית",
            "nameHe": "הפקולטה להנדסה ביו-רפואית",
            "nameEn": "Faculty of Biomedical Engineering",
        ...
        {
            "productionKey": "technion:faculty:faculty-biotechnology-food-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-biotechnology-food-engineering",
            "wikiSlug": "faculty-biotechnology-food-engineering",
            "name": "הפקולטה להנדסת ביוטכנולוגיה ומזון",
            "nameHe": "הפקולטה להנדסת ביוטכנולוגיה ומזון",
            "nameEn": "Faculty of Biotechnology and Food Engineering",
            "aliases": ["Biotechnology Engineering", "Food Engineering", "BFE"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        },
        {
            "productionKey": "technion:faculty:faculty-chemical-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-chemical-engineering",
            "wikiSlug": "faculty-chemical-engineering",
            "name": "הפקולטה להנדסה כימית",
            "nameHe": "הפקולטה להנדסה כימית",
            "nameEn": "Faculty of Chemical Engineering",
            "aliases": ["Chemical Engineering"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        },
        {
            "productionKey": "technion:faculty:faculty-chemistry:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-chemistry",
            "wikiSlug": "faculty-chemistry",
            "name": "הפקולטה לכימיה",
            "nameHe": "הפקולטה לכימיה",
            "nameEn": "Faculty of Chemistry",
            "aliases": ["Chemistry"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        ...
        {
            "productionKey": "technion:faculty:faculty-education-science-technology:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-education-science-technology",
            "wikiSlug": "faculty-education-science-technology",
            "name": "הפקולטה לחינוך למדע וטכנולוגיה",
            "nameHe": "חינוך למדע וטכנולוגיה",
            "nameEn": "Faculty of Education in Science and Technology",
            "aliases": [
        ...
        {
            "productionKey": "technion:faculty:faculty-electrical-computer-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-electrical-computer-engineering",
            "wikiSlug": "faculty-electrical-computer-engineering",
            "name": "הפקולטה להנדסת חשמל ומחשבים",
            "nameHe": "הפקולטה להנדסת חשמל ומחשבים",
            "nameEn": "Faculty of Electrical and Computer Engineering",
            "aliases": ["Electrical Engineering", "Computer Engineering", "ECE", "EE"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        },
        {
            "productionKey": "technion:faculty:faculty-materials-science-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-materials-science-engineering",
            "wikiSlug": "faculty-materials-science-engineering",
            "name": "הפקולטה למדע והנדסה של חומרים",
            "nameHe": "הפקולטה למדע והנדסה של חומרים",
            "nameEn": "Faculty of Materials Science and Engineering",
            "aliases": ["Materials Science", "Materials Engineering", "MSE"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        },
        {
            "productionKey": "technion:faculty:faculty-mathematics:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-mathematics",
            "wikiSlug": "faculty-mathematics",
            "name": "הפקולטה למתמטיקה",
            "nameHe": "הפקולטה למתמטיקה",
            "nameEn": "Faculty of Mathematics",
            "aliases": ["Mathematics"],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        ...
        {
            "productionKey": "technion:faculty:faculty-mechanical-engineering:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-mechanical-engineering",
            "wikiSlug": "faculty-mechanical-engineering",
            "name": "הפקולטה להנדסת מכונות",
            "nameHe": "הפקולטה להנדסת מכונות",
        ...
        {
            "productionKey": "technion:faculty:faculty-medicine:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-medicine",
            "wikiSlug": "faculty-medicine",
            "name": "הפקולטה לרפואה ע\"ש רות וברוס רפפורט",
            "nameHe": "הפקולטה לרפואה",
            "nameEn": "Ruth and Bruce Rappaport Faculty of Medicine",
            "aliases": [
                "Medicine",
                "Rappaport Faculty of Medicine",
                "הפקולטה לרפואה ע\"ש רות וברוס רפפורט",
            ],
            "catalogYear": 2025,
            "catalogVersion": "2025-2026",
            "status": "published",
        ...
        {
            "productionKey": "technion:faculty:faculty-physics:2025-2026",
            "institutionId": "technion",
            "facultyId": "faculty-physics",
            "wikiSlug": "faculty-physics",
            "name": "הפקולטה לפיזיקה",
            "nameHe": "הפקולטה לפיזיקה",
